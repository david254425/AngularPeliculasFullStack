...
@Component({
  ...
  standalone: true,
  imports: [MatButtonModule, MatFormFieldModule, ReactiveFormsModule, MatInputModule, MatDatepickerModule, InputImgComponent, RouterLink, SelectorMultipleComponent, AutocompleteActoresComponent],
